...
public abstract class EnemyPresenter : MonoBehaviour
{
    ...
    protected EnemyStateController stateCon;
    protected AlimentManager _aliment;
    protected CancellationTokenSource cts;

    public EnemyModel Model => _model;

    public AlimentManager Aliment => _aliment;
    ...
    public virtual void ManualStart()
    {
        ...
        _view.ManualStart();
        stateCon = new EnemyStateController();
        _aliment = GetComponent<AlimentManager>();
        _aliment.Initialize(this);
    ...
    public async UniTask DamageConstant(int damage)
    {
        ...
        Debug.Log("constatn Damage : " + damage);
